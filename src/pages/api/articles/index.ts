...
export async function GET(context: APIContext): Promise<Response> {
  try {
    ...
    const response = await listArticles(supabase, validatedParams, userId);
    ...
    return createJsonResponse(
      createErrorResponse("INTERNAL_SERVER_ERROR", "An unexpected error occurred while fetching articles"),
      500
    );
  }
}
